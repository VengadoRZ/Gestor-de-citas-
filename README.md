...
* **Frontend:** HTML5, CSS3, Tailwind CSS, plantillas de Django (Templates)
...
6. **Ejecutar el servidor de desarrollo y compilar estilos**
Para prender el compilador de Tailwind CSS en tiempo real, ejecuta:
```bash
...
En otra terminal, inicia el servidor de Django:
```bash
...
3. **Empresa:** * Navega a la opción de crear servicios y añade el catálogo de lo que ofrece el negocio.
